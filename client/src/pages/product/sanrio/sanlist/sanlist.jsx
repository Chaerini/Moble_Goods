...
import ProductSection from '../sanproductsection/sanproductsection';
import './sanlist.css';

function sanlist() {
  const pomProducts = [
    { id: 1, name: '폼폼푸린 인형', price: '₩25,000', image: '/images/pom1.jpeg' },
    ...
    { id: 5, name: '폼폼푸린 머그컵', price: '₩12,000', image: '/images/pom4.jpg' },
    { id: 6, name: '폼폼푸린 머그컵', price: '₩12,000', image: '/images/pom4.jpg' },
  ];
  const cinnaProducts = [
